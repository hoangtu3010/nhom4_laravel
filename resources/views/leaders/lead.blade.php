                                ...
                                @foreach ($lead as $item)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="{{url("/lead/edit", ["id"=>$item->id])}}" style="color: #17a2b8"><i class="far fa-edit"></i></a>
                                        </td>
                                        <td class="text-center">
                                            <a href="{{url("/lead/delete", ["id"=>$item->id])}}" style="color: #dc3545"><i class="fas fa-trash"></i></a>
                                        </td>
                                    </tr>
                                @endforeach
                                </tbody>
